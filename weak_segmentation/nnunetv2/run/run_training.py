...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
                          ...
                          num_epochs:int = 1000,  num_of_cycles:int = 1, 
                          gamma:float = 0.8): #$ added num_of_cycles, epochs and gamma
...
def run_training(dataset_name_or_id: Union[str, int],
                 ...
                 device: torch.device = torch.device('cuda'),
                 num_epochs:int = 1000, num_of_cycles:int = 1, 
                 gamma:float = 0.8): #$ added num_epochs, num_of_cycles and gamma
...
def run_training_entry():
    ...
    parser.add_argument('--num_epochs', type=int, default=250, required=False,
