...
setup(name='nnunetv2',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNetv2_run_uncertainty_on_fold = nnunetv2.nnunet.run_uncertainty_on_fold:run_uncertainty_on_fold_entry', #
              'nnUNetv2_predict_from_folder = nnunetv2.nnunet.predict_from_folder:predict_from_folder_entry' #
          ],
      },
